...
namespace Arreglos
{
    public partial class Form1 : Form
    {
        ...
        private void buttonPromedioSeccion_Click(object sender, EventArgs e)
        {
            int resultado;
            int contador = 0;
            int parcial = Convert.ToInt32(textBoxParcial2.Text) + 1;
            ...
            ClsPromedios Promedio = new ClsPromedios();
            resultado = Promedio.promedios_por_seccion(ArregloDosDimensiones, parcial, seccion);
            MessageBox.Show($"El promedio es: {resultado}");
        }
